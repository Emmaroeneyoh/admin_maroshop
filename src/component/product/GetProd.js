...
import { GetProducts, Searchproduct, Deleteproduct,  adminSignupReset } from '../../redux/Product'
...
//function to subnit
        ...
        <div class="col">
              ...
              <div class="col-12  mb-3">
                ...
                <div class="card-body">
                    ...
                    <Link to={'/create/product'}><button class="btn btn-success btn-block" type="button" data-toggle="modal" data-target="#user-form-modal">New Product</button></Link>
                    </div>
                    <hr class="my-3" />
                    <div className="row">
  ...
  <input type="text" class="form-control" onChange={changeEmail} value={title} placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2" />
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
            ...
            <div class="col mb-3">
                ...
                <div class="card-body">
                    ...
                    <h6 class="mr-2"><span>Products</span><small class="px-1">Details</small></h6>
                    </div>
                    <div class="e-table">
                                  ...
                                  if (title === '') {
                                      ...
                                      return val
                                                  ...
                                                  <tr key={user._id}>
                                                      ...
                                                      <td class="text-nowrap align-middle">{user.title }</td>
                                                      <td class="text-nowrap align-middle">{user.price }</td>
                                                      <td class="text-nowrap align-middle">{user.category.category }</td>
                                                      <td class="text-nowrap align-middle">{user.size }</td>
                                                      <td class="text-nowrap align-middle"><span>{moment(user.createdAt).subtract(10, 'days').calendar() }</span></td>
                                                  <td class="text-center align-middle">
                                                      <div class="btn-group align-top">
                                                              <button class="btn btn-sm btn-outline-secondary " type="button" >
                                                                  <Link to={`/product/edit/${user._id}`}>
